...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="navbar navbar-expand-sm navbar-light bg-white p-0 z-100" style={navStyle}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav mt-3 mb-3 justify-content-evenly w-100 align-items-center bg-light">
